...
SetPhrase(2, "Moi nguoi hay cung len, them nguoi thi them suc!:F")
SetPhrase(3, "Nguy hiem, chay le!:$")
SetPhrase(4, "Giup tai ha tang mau nhanh di!:M")
SetPhrase(5, "Co ai lap to doi khong? Tai ha dang co don qua!^o^")
SetPhrase(6, "Ba con co bac oi, hang nong hoi day!.:E")
SetPhrase(7, "Cac ha la nguoi o dau, cap bao nhieu roi?:o")
SetPhrase(8, "Huhu, cac huynh ty cho de xin it tien di!:) ")
SetPhrase(9, "Tai ha la nguoi moi, xin cac huynh ty chieu co!:I")
