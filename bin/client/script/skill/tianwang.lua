...
SKILLS = {
	...
	jinzhong_zhao = {                             --金钟罩
		...
		physicsres_p = { { { 1, 12 * 0.5 }, { 20, 50 * 0.5 } }, { { 1, 18 * 120 }, { 20, 18 * 180 } } },
		--fastwalkrun_p={{{1,2},{30,60},{31,60}},{{1,18*120},{20,18*180}}},
		poisonres_p = { { { 1, 12 * 0.5 }, { 20, 49 * 0.5 } }, { { 1, 18 * 120 }, { 20, 18 * 180 } } },
		coldres_p = { { { 1, 7 * 0.5 }, { 20, 45 * 0.5 } }, { { 1, 18 * 120 }, { 20, 18 * 180 } } },
		fireres_p = { { { 1, -5 * 0.5 }, { 20, -15 * 0.5 }, { 21, -15 * 0.5 } }, { { 1, 18 * 120 }, { 20, 18 * 180 } } },
