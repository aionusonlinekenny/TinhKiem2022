...
SKILLS = {
	...
	xinyan = { --心眼
		...
		lifemax_p = { { { 1, 80 }, { 20, 80 }, { 36, 80 } }, { { 1, -1 }, { 30, -1 } } }, --最大生命值（阳）由20%调整到80% 20160801
		...
		anti_block_rate = { { { 1, 1 }, { 30, 30 }, { 31, 30 } }, { { 1, 18 }, { 2, 18 } } },
		--fastwalkrun_p={{{1,1},{50,50},{51,50}},{{1,18},{2,18}}},
	...
	feidaotang150 = { --飞刀唐150
		physicsenhance_p = { { { 1, 22 }, { 10, 220 }, { 30, 660 }, { 50, 1100 }, { 51, 1100 } } },
		...
		skill_showevent = { { { 1, 0 }, { 10, 0 }, { 10, 4 }, { 20, 4 } } },
		missle_speed_v = { { { 1, 38 }, { 20, 48 }, { 21, 48 } } },
		skill_attackradius = { { { 1, 448 }, { 20, 512 }, { 21, 512 } } },
	...
	tangmen120 = { --120级技能
		...
		skill_desc =
			function(level)
				return "Kho秐g c竎h di h譶h t鑙 產: <color=orange>" ..
					floor(Link(level, SKILLS.tangmen120.skill_param1_v[1])) .. "<color>\n" ..
					"Th阨 gian kh玦 ph鬰 chi猽 th鴆: <color=orange>" ..
					floor(Link(level, SKILLS.tangmen120.skill_mintimepercast_v[1]) / 18) .. " gi﹜<color>\n" ..
					"Th阨 gian kh玦 ph鬰 chi猽 th鴆 tr猲 ng鵤: <color=orange>" ..
					floor(Link(level, SKILLS.tangmen120.skill_mintimepercastonhorse_v[1]) / 18) .. " gi﹜<color>\n"
			end,
