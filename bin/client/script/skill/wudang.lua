...
SKILLS = {
	...
	zuowang_wuwo = { --×øÍûÎÞÎÒ
		manashield_p = { { { 1, 25 }, { 5, 75 }, { 20, 99 }, { 21, 100 }, { 22, 100 } }, { { 1, 18 * 120 }, { 20, 18 * 360 } } },
		...
		skill_desc =
			function(level)
				return "Thêi gian kh«i phôc chiªu thøc: <color=orange>" ..
					floor(Link(level, SKILLS.wudang120.skill_mintimepercast_v[1]) / 18) .. " gi©y<color>\n" ..
					"Thêi gian kh«i phôc chiªu thøc trªn ngùa: <color=orange>" ..
					floor(Link(level, SKILLS.wudang120.skill_mintimepercastonhorse_v[1]) / 18) .. " gi©y<color>\n" ..
					"X¸c suÊt <color=orange>" ..
					floor(100 - Link(level, SKILLS.wudang120.missle_missrate[1])) ..
					"%<color> <color>lo¹i bá tr¹ng th¸i dÞ th­êng cho ®ång ®éi \n" ..
					"X¸c suÊt <color=orange>" ..
					floor(100 - Link(level, SKILLS.wudang120_child.missle_missrate[1])) ..
					"%<color> <color>tù lo¹i bá vµ miÔn dÞch tr¹ng th¸i dÞ th­êng trong <color=orange>" ..
