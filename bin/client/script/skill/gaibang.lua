...
SKILLS = {
	...
	zuidie_kuangwu = { --×íµú¿ñÎè
		allres_p = { { { 1, 1 }, { 30, 30 * 0.5 } }, { { 1, 18 * 120 }, { 30, 18 * 180 } } },
		...
		lifemax_p = { { { 1, 21 }, { 35, 60 }, { 36, 60 } }, { { 1, 18 * 120 }, { 30, 18 * 180 } } }, --¼ÓÇ¿ÉúÃü×î´óÖµ£¨Ñô£©
		...
		physicsres_p = { { { 1, 1 }, { 30, 30 }, { 31, 30 } }, { { 1, 18 * 120 }, { 30, 18 * 180 } } },
	},
