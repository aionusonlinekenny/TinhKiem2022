...
function SB_Page_1()
	local sL1 =
	"<color=gold>Liªn quan ®Õn S¬n trang<color>: <color=gray>X n¨m Y Ngò §éc thÊt ¶i thiÕt lËp ®Õn nay ch¼ng nh÷ng ®· thu nhËn nhiÒu danh kiÕm trong thiªn h¹, mµ cßn cã c«ng nghÖ ®óc t¹o vò khÝ phßng vÖ lµ tuyÖt kü bÝ truyÒn ®Ö nhÊt trong giang hå. NhiÒu nh©n sÜ t×m ®Õn mong t×m cho m×nh ThÇn Binh B¶o Gi¸p.<color>" ..
	"\n"
	local sL2 = "" .. ""
	local sL3 = "" .. ""
	local sL4 =
	"<color=gold>Liªn quan ®Õn Khiªu chiÕn<color>: <color=gray>HiÖn nay trang chñ mêi c¸c nh©n sÜ ®Õn Ngò §éc thÊt ¶i. Nh÷ng ai cã thµnh ý xin ®Õn gÆp sø gi¶ ë T­¬ng D­¬ng<color>." ..
	"\n"
	local sL5 = "" .. ""
	local sL6 = "" .. ""
	...
	Say("LINK:\\spr\\item\\questkey\\treasuremap_big.spr", 0, sL1 .. sL2 .. sL3 .. sL4 .. sL5 .. sL6, 5, sP1, sP2, sP3,
		sP4, sP0)
end
...
function SB_Page_2()
	...
	local nData = "<color=green>" ..
	nDataH ..
	"<color><color=water>:<color><color=green>" ..
	nDataM .. "<color><color=water>:<color><color=green>" .. nDataS .. "<color><color=water>'<color>"
	...
	local sL3 = "" .. "\n"
	local sL4 =
	"<color=gold>§iÓm tÝch lòy<color>: <color=gray>Tr×nh ®é h¶o h÷u biÓu thÞ tr×nh ®é quan hÖ thÕ lùc trong Ngò §éc thÊt ¶i.<color>" ..
	"\n"
...
function SB_Page_3()
	...
	local sL1 =
	"<color=gold>Tin tøc v­ît ¶i<color>: <color=gray>Th«ng qua sè lÇn tham dù vµ sè lÇn ®· th«ng qua ®Ó tÝnh tû lÖ.<color>" ..
	"\n"
	local sL2 = "  Sè lÇn tham dù: " .. nPlayed .. "  Sè lÇn v­ît ¶i: " .. nFinished ..
	"  Tû lÖ th«ng qua: " .. nSRate .. "\n"
	local sL3 = "" .. "\n"
	local sL4 = "<color=gold>Th«ng tin ¶i<color>: <color=gray>Ghi nhí vµi th«ng tin vuît ¶i ®¬n gi¶n.<color>" .. "\n"
	local sL5 = "  Tæng sè v­ît ¶i: " ..
	nStage .. "  Tæng sè s¸t qu¸i: " .. nKilled .. "  Sè lÇn ®éi tr­ëng: " .. nBecaptain .. "\n"
	local sL6 = "" .. "\n"
