local faction_skill_list = {
	...
	[11] = {[90] = {1983, 1967}, [120] = {1984}, [150] = {1985, 1969},},
	[12] = {[90] = {2141, 2124}, [120] = {2127}, [150] = {2142, 2129},},
}
...
function CheckIsCanGet150SkillTask()
	local nTransLife = GetTranslife()
	local nHaveTSFlag = 0;
	if(nTransLife > 1 ) then
		nHaveTSFlag = 1
	end
	
	local nFact = GetFactionNo()
...
function main(sel)
	Genre, DetailType=FindItemEx(sel)
	if (LearnSkillByBook(DetailType, sbook_list) ==0) then
		RemoveItem(sel,1);
	end;
end