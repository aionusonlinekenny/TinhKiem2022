...
function main(nItemIndex)
	...
	if D == 2410 then
		AddItemID(AddItem(0, 4, 195, 0, 0, 0, 0, 0));
		RemoveItem(nItemIndex, 1);
		return 0;
	end

	if D == 2401 then
		AddItemID(AddItem(0, 6, 2221, 0, 0, 0, 0, 0));
		RemoveItem(nItemIndex, 1);
		return 0;
	end
	...
	if D == 2337 then
		AddItemID(AddItem(0, 0, 10, 5, 2, 0, 0));
		RemoveItem(nItemIndex, 1);
		return 0;
	end

	if D == 2338 then
		AddItemID(AddItem(0, 0, 10, 5, 4, 0, 0));
		RemoveItem(nItemIndex, 1);
		return 0;
	end

	if D == 2339 then
		AddItemID(AddItem(0, 0, 10, 5, 3, 0, 0));
		RemoveItem(nItemIndex, 1);
		return 0;
	end

	if D == 2340 then
		AddItemID(AddItem(0, 0, 10, 5, 1, 0, 0));
		RemoveItem(nItemIndex, 1);
		return 0;
	end
	...
	if D == 2342 then
		AddItemID(AddItem(0, 0, 10, 6, 1, 0, 0));
		RemoveItem(nItemIndex, 1);
		return 0;
	end

	if D == 2343 then
		AddItemID(AddItem(0, 0, 10, 7, 1, 0, 0));
		RemoveItem(nItemIndex, 1);
		return 0;
	end

	if D == 2405 then
		AddItemID(AddItem(0, 0, 10, 8, 1, 0, 0));
		RemoveItem(nItemIndex, 1);
		return 0;
	end
