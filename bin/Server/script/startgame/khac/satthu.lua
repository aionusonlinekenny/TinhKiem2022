...
function addnpcsatthu()
	...
	nNpcIndex = AddNpcNew(812, 100, 75, 52202, 101334, DEATHFILEST,
		5, "Gia C¸t Kinh Hång", 1, RANDOMC(0, 1, 2, 3, 4), 0, 500000, 100, 8000, nil, 10, 20, nil, 2000, 50, 2,
		DROPFILEST)
	...
	nNpcIndex = AddNpcNew(818, 100, 340, 61636, 88584, DEATHFILEST,
		5, "NhËm Th­¬ng Khung", 1, RANDOMC(0, 1, 2, 3, 4), 0, 500000, 100, 8000, nil, 10, 20, nil, 2000, 50, 2,
		DROPFILEST)
