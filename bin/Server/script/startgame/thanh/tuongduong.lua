...
function addnpctuongduong()
	...
	AddNpcNew(1275,1,78,1553*32,3226*32,"\\script\\event\\minhnguyettran\\bepluanaubanh.lua",6, "BÕp löa")
...
function addobjtuongduong()
	AddObj(297,78,48889,93396,"",0,0)
	AddObj(294,78,49806,93422,"",0,0)
	AddObj(285,78,45418,95475,"\\script\\maps\\tuongduong\\obj\\tuthiet.lua",0,0)
	AddObj(284,78,46896,95474,"\\script\\maps\\tuongduong\\obj\\xichdong.lua",0,0)
	AddObj(297,78,52600,95956,"",0,0)
	AddObj(294,78,53144,96505,"",0,0)
	AddObj(285,78,43488,98863,"\\script\\maps\\tuongduong\\obj\\tuthiet.lua",0,0)
	AddObj(283,78,44872,98519,"\\script\\maps\\tuongduong\\obj\\luongngan.lua",0,0)
	AddObj(297,78,56208,98998,"",0,0)
	AddObj(283,78,41938,100032,"\\script\\maps\\tuongduong\\obj\\luongngan.lua",0,0)
	AddObj(284,78,44408,101211,"\\script\\maps\\tuongduong\\obj\\xichdong.lua",0,0)
	--AddObj(1,78,47419,101224,"",0,0)
	AddObj(285,78,41893,101740,"\\script\\maps\\tuongduong\\obj\\tuthiet.lua",0,0)
	AddObj(3,78,46913,101758,"",0,0)
	AddObj(283,78,43598,102469,"\\script\\maps\\tuongduong\\obj\\luongngan.lua",0,0)
	--AddObj(1,78,50013,103004,"",0,0)
	AddObj(3,78,51460,103013,"",0,0)
	AddObj(284,78,42574,104250,"\\script\\maps\\tuongduong\\obj\\xichdong.lua",0,0)
	--AddObj(1,78,53997,103503,"",0,0)
	AddObj(4,78,54457,103699,"\\script\\maps\\bangcaothi.lua",0,0)
	--AddObj(1,78,46408,104456,"",0,0)
	--AddObj(1,78,50430,106889,"",0,0)
	AddObj(3,78,50756,108359,"",0,0)
	AddObj(296,78,57673,109095,"",0,0)
	AddObj(297,78,57300,110422,"",0,0)	
end;