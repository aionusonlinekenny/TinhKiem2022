...
function seldc(sel)
	for i=1,5 do
		AddItemID(AddItem(0,0,4,0,10,sel,100,10));
		AddItemID(AddItem(0,0,4,1,10,sel,100,10));
	end
end

function selnhan(sel)
	for i=1,10 do
		AddItemID(AddItem(0,0,3,0,10,sel,100,10));
	end
end

function selnb(sel)
	for i=1,5 do
		AddItemID(AddItem(0,0,9,0,10,sel,100,10));
		AddItemID(AddItem(0,0,9,1,10,sel,100,10));
	end
end