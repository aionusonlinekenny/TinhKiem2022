...
function main()
	...
	--	return
	--end
	Say("LINK:<npc>", 0, 10194, 3, "Ta ®Õn lµm nhiÖm vô ChÝnh tuyÕn cÊp 20 trë lªn/nhiemvuchinh",
		"Ta ®Õn xem giíi thiÖu vÒ nhiÖm vô /xemgioithieu", "Sau nµy h·y nãi/no")
end;
...
function donechinh()
	...
	Msg2Player(
	"B¹n ®· hoµn thµnh nhiÖm vô M¹c SÇu giao. Long Ngò v« cïng hµi lßng, nh­ng b­íc ®­êng giang hå chØ míi b¾t ®Çu.")
end;
...
function donetrung()
	...
	Msg2Player("B¹n B¹n nhËn ®­îc mét mãn b¶o khÝ.")
	Msg2Player(
	"B¹n ®· hoµn thµnh nhiÖm vô s¸t thñ Phã Nam B¨ng giao. Trªn giang hå b¹n ®· cã chót danh tiÕng, ®©y còng kh«ng ph¶i lµ chuyÖn tèt, trong thµnh cã nhiÒu tai m¾t theo dâi.")
end;
...
function doneta()
	if (DelItem(1, 0, 4, 463) == 1) then
		...
		Msg2Player("B¹n B¹n nhËn ®­îc mét mãn b¶o khÝ.")
		Msg2Player(
		"B¹n ®· hoµn thµnh nhiÖm vô chñ tuyÕn Tµ ph¸i. Sau nµy cã lÏ cã nhiÒu trËn chiÕn ®ang chê b¹n, mét kÎ m¸u l¹nh.")
	end
end;
