...
TOUSHI_COLDDOWN_TIME    =   0*24*60*60;                     -- ×ªÃÅÅÉÀäÈ´Ê±¼ä(µ¥Î»:Ãë)
...
TB_TOUSHI_ERR_MSG			= 							-- ´íÎóÌáÊ¾ÐÅÏ¢
	{
		[TOUSHI_UNKNOWN]		= "<npc> Kh«ng thÓ lµm nh­ vËy ®­îc.",
		[TOUSHI_LVLERR]			= "<npc> HiÖn t¹i ng­¬i vÉn ch­a ®ñ {cÊp 120}, h·y ®i rÌn luyÖn thªm ®i!",
		[TOUSHI_FLAGERR]		= "<npc> Muèn gia nhËp bæn bang, ch­ëng m«n cña ng­¬i ®· ®ång ý ch­a?",
		[TOUSHI_LGERR]			= "<npc> Muèn gia nhËp bæn bang, cÇn ph¶i {gi¶i t¸n quan hÖ chiÕn ®éi liªn ®Êu}.",
		[TOUSHI_EQUIPERR]		= "<npc> Muèn gia nhËp bæn bang, cÇn ph¶i cëi hÕt trang bÞ trªn ng­êi xuèng!",
		[TOUSHI_REDOERR]		= "<npc><sex> ®· chuyÓn thµnh c«ng sang m«n ph¸i míi.",
		[TOUSHI_EQFACTERR]		= "<npc> S­ phô cho phÐp ng­¬i xuèng nói t×m con ®­êng vâ häc míi, vµ còng hi väng ng­¬i cã ngµy hïng b¸ thiªn h¹",
		[TOUSHI_MALEERR]		= "><npc> VÞ <sex> ®· t×m ®Êy ®Õn ®©y, ch¾c còng ®· biÕt tÊt c¶ sù viÖc tõ ch­ëng m«n mµ ®Õn. Nh­ng mµ ng­¬i kh«ng phï hîp gia nhËp víi m«n ph¸i.",
		[TOUSHI_TWFEMALEERR]	= "<npc> Ng­¬i vÉn ch­a cã tÝn vËt cña bæn bang chñ, kh«ng thÓ gia nhËp ®­îc m«n ph¸i.",
		[TOUSHI_NOFACTERR]		= "<npc> ThËt lµ kú l¹! Ta nhËn kh«ng ra ng­¬i tu luyÖn vâ c«ng thuéc m«n ph¸i nµo?",
		[TOUSHI_NOFREEBAG]		= "<npc> Hµnh trang kh«ng ®ñ, h·y s¾p xÕp råi quay l¹i nhÐ.",
		[TOUSHI_TIMEERR]		= format("<npc> Sau khi chuyÓn m«n ph¸i <color=green>%d<color> ngµy míi cã thÓ tiÕp tôc chuyÓn.", TOUSHI_COLDDOWN_TIME/(24*60*60)),
	}
...
TB_DAIYITOUSHI_FACTS = 					-- ¸÷ÃÅÅÉ ¼¼ÄÜ ³ÆºÅµÈ
	...
	tbSkillID		=	{
		...
		[60]	=	{1355,1379},
		[70]	=	{1358,1360,1380,},
		[90]	=	{{1382, 1, "QuyÒn ph¸p"},{1364, 1, "KiÕm ph¸p"},},
		[120]	=	{{1365, 1}},
		[150]	=	{{1384, 1, "QuyÒn ph¸p"},{1369, 1, "KiÕm ph¸p"},},

	},
			szMsg = "KÓ tõ h«m nay, %s gia nhËp Hoa S¬n ph¸i, tham kiÕn c¸c s­ huynh s­ tû!",
