...
function main(NpcIndex)
	...
	if (nValue == 1 and nNumItem > 0) then
		Say(10374, 1,
			END_TALK .. "/no");
		DelItem(nNumItem, 0, 4, 455);
		SetTask(TASK_NVST, SetNumber(2, nTaskValue, 2, 2));
		Msg2Player("M¹c SÇu b¶o b¹n ra bÕn tµu ngoµi thµnh gÆp c« Êy")
		AddNote(1, 2,
			"M¹c SÇu ph¸t hiÖn trong th­ cã ®éc! B¹n kh«ng muèn lé danh tÝnh cña Long Ngò, xem ra bªn trong cã uÈn khóc. M¹c SÇu hÑn b¹n ë ngoµi thµnh §¹i Lý. ¸c chiÕn xem ra khã tr¸nh khái.");
...
function nv_30()
	...
	AddNote(1, 2,
		"M¹c SÇu rÊt ng­ìng mé b¹n vµ hÐ lé tin tøc cña Thiªn Hoµng Long KhÝ. Bé gi¸p nµy TÇn Thñy Hoµng triÖu tËp thî rÌn 7 n­íc chÕ t¹o ra. Xung quanh bé gi¸p thÇn bÝ nµy cßn bao nhiªu ©m m­u?");
	AddNote(1, 2,
		"M¹c SÇu b¶o b¹n ®i <color=red>Ph­îng T­êng<color> t×m Ng¹o V©n T«ng<color=red> (198,206)<color>, «ng ta sÏ cho b¹n biÕt nhiÒu bÝ mËt!");
	AddNote(1, 0,
		"C«ng Tö TiÕu<enter>C«ng Tö TiÕu cña c¶i nh­ nói, m«n h¹ cã h¬n 3 ngµn sÜ tö. Nh­ng chØ v× 1 ch÷ T×nh mµ bÊt chÊp tÊt c¶.");
	AddNote(1, 1,
		"M¹c SÇu b¶o b¹n ®i Thµnh §« TÝn T­íng Tù t×m C«ng Tö TiÕu ®iÒu tra tung tÝch cña Hoµng Kim L©n (403,319)");
end;
...
function done40()
	...
	Msg2Player(
	"M¹c SÇu nãi sau nµy sÏ t×m b¹n. C« ta sÏ gióp b¹n tiÕn hµnh tÈy tñy, b¹n ®· cã c¬ héi söa ®iÓm kü n¨ng. NÕu b¹n kh«ng thuéc phe chÝnh ph¸i sÏ kh«ng ®­îc c¬ héi nµy.")
