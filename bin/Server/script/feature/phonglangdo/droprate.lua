...
function DropRate(NpcIndex)
	...
	if (btype == 1) then --boss xanh
		...
		for i = 1, dropnum do
			...
			elseif (nSel == 9) then
				...
				elseif (nSel == 899) then
					DropItem(NpcIndex, AddItem(0, 6, 49, 0, 0, 5, 0, 0)) --bikip cui`
				elseif (nSel == 799) then
					DropItem(NpcIndex, AddItem(0, 6, 52, 0, 0, 5, 0, 0)) --bikip cui`
				elseif (nSel == 699) then
					DropItem(NpcIndex, AddItem(0, 6, 53, 0, 0, 5, 0, 0)) --bikip cui`
				else
					bluedetail = RANDOM(9);
					blueparti = RANDOM(ITEMLIST[bluedetail + 1]);
					DropItem(NpcIndex, AddItem(0, 0, bluedetail, blueparti, RANDOM(8, 10), ser, pluck,
	...
	elseif (nSel == 5) then
		...
		DropItem(NpcIndex, AddItem(0, 0, detail, parti, RANDOM(6, 10), ser, pluck,
