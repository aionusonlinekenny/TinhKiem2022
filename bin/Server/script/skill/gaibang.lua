...
SKILLS = {
	...
	huabu_liushou = { --»¬²»ÁôÊÖ
		fastwalkrun_p = { { { 1, 9 }, { 20, 66 } }, { { 1, 18 * 120 }, { 20, 18 * 60 * 5 } } },
	...
	dagou_zhen = { --´ò¹·Õó
		...
		lifemax_p = { { { 1, 1 }, { 50, 50 }, { 51, 50 } }, { { 1, -1 }, { 30, -1 } }, { { 1, 2 }, { 2, 2 } } },
	...
	zuidie_kuangwu = { --×íµú¿ñÎè
		allres_p = { { { 1, 1 }, { 30, 30 * 0.5 } }, { { 1, 18 * 120 }, { 30, 18 * 60 * 5 } } },
		addfiremagic_v = { { { 1, 10 }, { 30, 215 } }, { { 1, 18 * 120 }, { 30, 18 * 60 * 5 } } },
		addfiredamage_v = { { { 1, 10 }, { 30, 175 } }, { { 1, 18 * 120 }, { 30, 18 * 60 * 5 } } },
		deadlystrikeenhance_p = { { { 1, 5 }, { 20, 30, Conic } }, { { 1, 18 * 120 }, { 30, 18 * 60 * 5 } } },
		--lifemax_yan_p={{{1,21},{35,20},{36,20}},{{1,-1},{30,-1}}},
		lifemax_p = { { { 1, 21 }, { 35, 60 }, { 36, 60 } }, { { 1, 18 * 120 }, { 30, 18 * 60 * 5 } } }, --¼ÓÇ¿ÉúÃü×î´óÖµ£¨Ñô£©
		me2metaldamage_p = { { { 1, 1 }, { 30, 20 }, { 31, 20 } }, { { 1, 18 * 120 }, { 30, 18 * 60 * 5 } } }, --¶Ô½ðÏµÉËº¦Ôö¼Ó£º15%
		metal2medamage_p = { { { 1, 1 }, { 30, 20 }, { 31, 20 } }, { { 1, 18 * 120 }, { 30, 18 * 60 * 5 } } }, --¼õÉÙÀ´×Ô½ðÏµµÄÉËº¦£º15%
		returnres_p = { { { 1, 1 }, { 39, 20 }, { 40, 20 } }, { { 1, 18 * 120 }, { 30, 18 * 60 * 5 } } }, --Ôö¼Ó¶Ô·´µ¯ÉËº¦µÄ¿¹ÐÔ£¬Ã¿¼¶1%£¬ÉÏÏÞ40%
		skill_cost_v = { { { 1, 50 }, { 20, 100 } } },
		anti_do_hurt_p = { { { 1, 0 }, { 29, 0 }, { 30, 10 }, { 40, 20 }, { 41, 20 } }, { { 1, 18 * 120 }, { 30, 18 * 60 * 5 } } },
		physicsres_p = { { { 1, 1 }, { 30, 30 }, { 31, 30 } }, { { 1, 18 * 120 }, { 30, 18 * 60 * 5 } } },
	},
	...
	gaibang120 = { --Ø¤°ï120¼¶¼¼ÄÜ
		...
		skill_desc =
			function(level)
				return "X¸c suÊt <color=orange>" ..
					floor(Link(level, SKILLS.gaibang120.autoattackskill[3]) - 12 * 18 * 256) ..
					"%<color> g©y ho¹i th­¬ng \n" ..
					"S¸t th­¬ng löa ®èt khiÕn Phßng Thñ VËt Lý (D­¬ng) gi¶m <color=orange>" ..
					floor(-Link(level, SKILLS.gaibang120zuzhou.physicsres_p[1])) ..
					"%<color>, Háa Phßng (D­¬ng) gi¶m <color=orange>" ..
					floor(-Link(level, SKILLS.gaibang120zuzhou.fireres_p[1])) ..
					"%<color>,\n ®ång thêi lµm gi¶m gi¸ trÞ phßng thñ vËt lý lín nhÊt <color=orange>" ..
					floor(-Link(level, SKILLS.gaibang120zuzhou.physicsresmax_p[1])) ..
					"%<color>,gi¶m gi¸ trÞ phßng háa lín nhÊt <color=orange>" ..
					floor(-Link(level, SKILLS.gaibang120zuzhou.fireresmax_p[1])) ..
					"%<color>, gi¶m tèc ®é di chuyÓn <color=orange>" ..
					floor(-Link(level, SKILLS.gaibang120zuzhou.fastwalkrun_p[1])) ..
					"%<color> kh¸ng háa \n ®ång thêi ph¶n ®ßn khi bÞ tÊn c«ng tÇm xa gi¶m <color=orange>" ..
					floor(-Link(level, SKILLS.gaibang120zuzhou.rangedamagereturn_p[1])) ..
					"%<color> tèc ®é di chuyÓn trong <color=orange>" ..
					floor(Link(level, SKILLS.gaibang120zuzhou.physicsres_p[2]) / 18) .. " gi©y<color>\n" ..
					"Trong vßng <color=orange>" ..
					floor((Link(level, SKILLS.gaibang120.autoattackskill[3]) / (18 * 256))) ..
	...
	gaibang120zuzhou = { --Ø¤°ï120¼¶¼¼ÄÜ×çÖä
		physicsres_p = { { { 1, -1 }, { 25, -20 }, { 26, -20 } }, { { 1, 3 * 18 }, { 15, 8 * 18 }, { 20, 9 * 18 }, { 21, 9 * 18 } } },
		fireres_p = { { { 1, -1 }, { 25, -20 }, { 26, -20 } }, { { 1, 3 * 18 }, { 15, 8 * 18 }, { 20, 9 * 18 }, { 21, 9 * 18 } } },
