...
SKILLS = {
	...
	huti_hanbing = { --护体寒冰
		meleedamagereturn_p = { { { 1, 5 }, { 20, 20 } }, { { 1, 18 * 120 }, { 20, 18 * 60 * 5 } } },
		rangedamagereturn_p = { { { 1, 5 }, { 20, 20 } }, { { 1, 18 * 120 }, { 20, 18 * 60 * 5 } } },
	...
	xueying = { --雪影
		attackspeed_v = { { { 1, 12 }, { 20, 65 }, { 23, 73 }, { 25, 90 }, { 28, 99 }, { 42, 111 }, { 43, 119 }, { 44, 122 } }, { { 1, 18 * 300 }, { 20, 18 * 60 * 5 } } },
		castspeed_v = { { { 1, 12 }, { 20, 65 }, { 23, 73 }, { 25, 90 }, { 28, 99 }, { 42, 111 }, { 43, 119 }, { 44, 122 } }, { { 1, 18 * 300 }, { 20, 18 * 60 * 5 } } },
		fastwalkrun_p = { { { 1, 17 }, { 20, 55 } }, { { 1, 18 * 120 }, { 20, 18 * 60 * 5 } } },
	...
	binggu_xuexin = { --冰骨雪心
		...
		fasthitrecover_v = { { { 1, 1 }, { 39, 30 }, { 40, 31 } }, { { 1, -1 }, { 2, -1 } } },
		...
		allres_p = { { { 1, 1 }, { 10, 5 }, { 20, 10 }, { 21, 10 } }, { { 1, -1 }, { 2, -1 } } },
		anti_block_rate = { { { 1, 1 }, { 30, 30 }, { 31, 30 } }, { { 1, -1 }, { 2, -1 } } },
		returnres_p = { { { 1, 1 }, { 30, 30 }, { 31, 30 } }, { { 1, -1 }, { 2, -1 } } },                              --反弹抗性
		enhancehit_rate = { { { 1, 1 }, { 10, 2 }, { 20, 3 }, { 30, 4 }, { 40, 5 }, { 50, 5 } }, { { 1, -1 }, { 2, -1 } } }, --重击概率
		lifemax_p = { { { 1, 3 }, { 30, 90 }, { 50, 150 }, { 51, 150 } }, { { 1, -1 }, { 30, -1 } } },
	...
	daocuiyan150 = { --刀翠烟150
		...
		missle_speed_v = { { { 1, 37 }, { 20, 37 }, { 21, 37 } } }, --增加子弹飞行速度
		skill_misslenum_v = { { { 1, 3 }, { 5, 3 }, { 20, 3 }, { 21, 3 } } },
		skill_attackradius = { { { 1, 448 }, { 20, 512 }, { 21, 512 } } },
	...
	neicuiyan150 = { --内翠烟150
		...
		--},
		physicsdamage_v = {
			[1] = { { 1, 160 }, { 30, 2500 }, { 50, 5000 }, { 51, 5000 } },
			[3] = { { 1, 160 }, { 30, 2500 }, { 50, 5000 }, { 51, 5000 } },
		},
		colddamage_v = {
			[1] = { { 1, 160 }, { 30, 2500 }, { 50, 5000 }, { 51, 5000 } },
			[3] = { { 1, 160 }, { 30, 2500 }, { 50, 5000 }, { 51, 5000 } },
	...
	cuiyan120 = { --翠烟120级技能
		...
		skill_mintimepercast_v = { { { 1, 60 * 18 }, { 10, 40 * 18 }, { 30, 30 * 18 }, { 31, 30 * 18 } } },
		skill_mintimepercastonhorse_v = { { { 1, 60 * 18 }, { 10, 40 * 18 }, { 30, 30 * 18 }, { 31, 30 * 18 } } },
		enhancehiteffect_rate = { { { 1, 1 }, { 24, 24 }, { 25, 100 }, { 26, 100 } }, { { 1, 5 * 18 }, { 20, 15 * 18 }, { 21, 15 * 18 } } },
		skill_desc =
			function(level)
				return "Th阨 gian kh玦 ph鬰 chi猽 th鴆: <color=orange>" ..
					floor(Link(level, SKILLS.cuiyan120.skill_mintimepercast_v[1]) / 18) .. " gi﹜<color>\n"
			end,
