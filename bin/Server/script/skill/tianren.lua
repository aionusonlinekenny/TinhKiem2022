...
SKILLS = {
	...
	huolian_fenhua = { --»ðÁ«·Ù»ª
		...
		skill_desc =
			function(level)
				return
					"Thêi gian kh«i phôc chiªu thøc: <color=orange>" ..
					floor(Link(level, SKILLS.huolian_fenhua.skill_mintimepercast_v[1]) / 18) .. " gi©y<color>\n"
			end,
	},
	huanying_feihu = { --»ÃÓ°·Éºü
		...
		skill_desc =
			function(level)
				return
					"Thêi gian kh«i phôc chiªu thøc: <color=orange>" ..
					floor(Link(level, SKILLS.huanying_feihu.skill_mintimepercast_v[1]) / 18) .. " gi©y<color>\n"
			end,
	},
	...
	feihong_wuji = { --·ÉºèÎÞ¼£
		...
		skill_desc =
			function(level)
				return
					"Thêi gian kh«i phôc chiªu thøc: <color=orange>" ..
					floor(Link(level, SKILLS.feihong_wuji.skill_mintimepercast_v[1]) / 18) .. " gi©y<color>\n"
			end,
	...
	limo_duopo = { --À÷Ä§¶áÆÇ
		...
		skill_desc =
			function(level)
				return
					"Thêi gian kh«i phôc chiªu thøc: <color=orange>" ..
					floor(Link(level, SKILLS.limo_duopo.skill_mintimepercast_v[1]) / 18) .. " gi©y<color>\n"
			end,
	...
	tianmo_jieti = { --ÌìÄ§½âÌå
		...
		fasthitrecover_v = { { { 1, 5 }, { 20, 49 }, { 21, 49 } }, { { 1, 18 * 120 }, { 20, 18 * 360 } } },
		...
		--attackspeed_v={{{1,0},{38,0},{39,60},{40,60}},{{1,18*120},{30,18*360}}},--Ôö¼ÓÍâ¹¦ÏµÎä¹¦³öÕÐ¶¯×÷£¨Ñô£©
		castspeed_v = { { { 1, 26 }, { 30, 81 }, { 33, 86 }, { 35, 101 }, { 36, 103 } }, { { 1, 18 * 120 }, { 30, 18 * 360 } } },
		lifemax_p = { { { 1, 60 }, { 20, 60 } }, { { 1, 18 * 45 }, { 30, 18 * 180 } } },
	...
	beisu_qingfeng = { --±¯ËÖÇå·ç
		...
		skill_desc =
			function(level)
				return
					"Thêi gian kh«i phôc chiªu thøc: <color=orange>" ..
					floor(Link(level, SKILLS.beisu_qingfeng.skill_mintimepercast_v[1]) / 18) .. " gi©y<color>\n"
			end,
	},
	yunlong_ji = { --ÔÆÁú»÷
	...
	zhanren150 = { --Õ½ÈÌ150
		physicsenhance_p = { { { 1, 26 }, { 50, 2300 }, { 51, 2300 } } },
		seriesdamage_p = { { { 1, 40 }, { 15, 40 }, { 20, 80 }, { 21, 82 } } },
		deadlystrike_p = { { { 1, 6 }, { 20, 80 }, { 23, 103 }, { 26, 115 } } },
		firedamage_v = {
			[1] = { { 1, 10 }, { 15, 120 }, { 20, 455 }, { 23, 1257 }, { 26, 1658 } },
			[3] = { { 1, 10 }, { 15, 120 }, { 20, 455 }, { 23, 1257 }, { 26, 1658 } }
		},
		...
		skill_desc =
			function(level)
				...
				return "T¨ng thªm h×nh thøc thø hai <color=blue> ma ©m kÝch <color> vµ <color=orange>" ..
					floor(100 - Link(level, SKILLS.zhanren150.missle_missrate[1])) ..
					"%<color>Tû lÖ khiÕn cho ®èi ph­¬ng khiÕp sî" ..
	...
	moren150 = { --Ä§ÈÌ150	¼²»ðÁÇÔ­
		...
		--},
		fatallystrike_p = { { { 1, 10 }, { 20, 40 } } },
		--¼õÉÙÖÂÃüÒ»»÷ÂÊ£¬Ôö¼Ó»ð¹¥ÉËº¦
		firedamage_v = {
			[1] = { { 1, 200 }, { 20, 2000 }, { 30, 3000 }, { 40, 4000 }, { 50, 5000 }, { 51, 5000 } }, --»ðÉËÃ¿¼¶Ôö¼Ó10µã 20160801
			[3] = { { 1, 200 }, { 20, 2000 }, { 30, 3000 }, { 40, 4000 }, { 50, 5000 }, { 51, 5000 } }
	...
	shehun_luanxin = { --Éã»êÂÒÐÄ
		...
		skill_desc =
			function(level)
				return
					"Thêi gian kh«i phôc chiªu thøc: <color=orange>" ..
					floor(Link(level, SKILLS.shehun_luanxin.skill_mintimepercast_v[1]) / 18) .. " gi©y<color>\n"
			end,
	},
	tianren120 = { --ÌìÈÌ120¼¶¼¼ÄÜ
		...
		skill_desc =
			function(level)
				return "Thêi gian kh«i phôc chiªu thøc: <color=orange>" ..
					floor(Link(level, SKILLS.tianren120.skill_mintimepercast_v[1]) / 18) .. " gi©y<color>\n" ..
					"Thêi gian kh«i phôc chiªu thøc trªn ngùa: <color=orange>" ..
					floor(Link(level, SKILLS.tianren120.skill_mintimepercastonhorse_v[1]) / 18) .. " gi©y<color>\n" ..
					...
					"Sau khi chÕt cã x¸c suÊt <color=orange>" ..
					floor(Link(level, SKILLS.tianren120.autodeathskill[3])) .. "%<color> khiÕn cho tèi ®a " ..
					floor(Link(level, SKILLS.quntisuijizoudong.missle_hitcount[1])) ..
					" môc tiªu gÇn bÞ ho¶ng lo¹n trong <color=orange>" ..
					floor(Link(level, SKILLS.quntisuijizoudong.randmove[2]) / 18) .. " gi©y<color>\n" ..
