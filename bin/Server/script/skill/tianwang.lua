...
SKILLS = {
	...
	jingxin_jue = { --静心诀
		...
		attackratingenhance_p = { { { 1, 95 }, { 20, 900 } }, { { 1, 18 * 120 }, { 20, 18 * 360 } } }, --命中每级提升5%
	...
	tianwang_zhanyi = { --天王战意
		...
		anti_hitrecover = { { { 1, 1 }, { 50, 50 }, { 51, 50 } }, { { 1, -1 }, { 2, -1 } } }, --每一级增加敌人受伤动作时间0.5,25是上限 20160926
	...
	jinzhong_zhao = {                             --金钟罩
		sorbdamage_p = { { { 1, 2 }, { 20, 40 } }, { { 1, 18 }, { 2, 18 } } }, --增加抵消伤害（阳），1级2点，edited By LLX
		physicsres_p = { { { 1, 12 * 0.5 }, { 20, 50 * 0.5 } }, { { 1, 18 * 120 }, { 20, 18 * 360 } } },
		--fastwalkrun_p={{{1,2},{30,60},{31,60}},{{1,18*120},{20,18*180}}},
		poisonres_p = { { { 1, 12 * 0.5 }, { 20, 49 * 0.5 } }, { { 1, 18 * 120 }, { 20, 18 * 360 } } },
		coldres_p = { { { 1, 7 * 0.5 }, { 20, 45 * 0.5 } }, { { 1, 18 * 120 }, { 20, 18 * 360 } } },
		fireres_p = { { { 1, -5 * 0.5 }, { 20, -15 * 0.5 }, { 21, -15 * 0.5 } }, { { 1, 18 * 120 }, { 20, 18 * 360 } } },
		coldenhance_p = { { { 1, 1 }, { 30, 50 }, { 31, 50 } }, { { 1, 18 * 120 }, { 20, 18 * 360 } } },
