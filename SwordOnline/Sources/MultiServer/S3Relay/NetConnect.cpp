...
BOOL CNetConnectDup::SendPackage(const void* pData, UINT size) const
{
...
CNetConnect::CNetConnect(CNetServer* pNetServer, ULONG id)
...
HRESULT CNetConnect::OnMessage( VOID* pData, UINT size )
{
...
BOOL CNetConnect::SendPackage(const void* pData, UINT size)
{
