...
void _Proc2_Relay_AskWay_AccountRoleID(const CNetSockDupEx& NetSockDupEx, const void* pData, UINT size)
{
...
void _Proc1_Relay_Data(const CNetSockDupEx& NetSockDupEx, const void* pData, UINT size)
{
...
void _Proc1_Relay_AskWay(const CNetSockDupEx& NetSockDupEx, const void* pData, UINT size)
{
	RELAY_ASKWAY_DATA* pAskWayData = (RELAY_ASKWAY_DATA*)pData;
...
void _Proc1_Relay_LoseWay(const CNetSockDupEx& NetSockDupEx, const void* pData, UINT size)
{
...
void _Proc0_Relay(const CNetSockDupEx& NetSockDupEx, const void* pData, UINT size)
{
...
void _RecvPackage(const CNetSockDupEx& NetSockDupEx, const void* pData, UINT size)
{
	EXTEND_HEADER* pHeader = (EXTEND_HEADER*)pData;
