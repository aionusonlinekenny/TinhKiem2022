...
protected:
	virtual CNetConnect* CreateConnect(CNetServer* pNetServer, ULONG id);
...
public:
	...
	BOOL FindPlayerByAcc(CHostConnect* pConn, const std::_tstring& acc, CNetConnectDup* pConnDup, std::_tstring* pRole, DWORD* pNameID, ULONG* pParam, std::_tstring* pRealAcc = NULL);
	BOOL FindPlayerByRole(CHostConnect* pConn, const std::_tstring& role, CNetConnectDup* pConnDup, std::_tstring* pAcc, DWORD* pNameID, ULONG* pParam, std::_tstring* pRealRole = NULL);
	BOOL FindPlayerByIpParam(CHostConnect* pConn, DWORD ip, ULONG param, CNetConnectDup* pConnDup, std::_tstring* pAcc, std::_tstring* pRole, DWORD* pNameID);
