...
BOOL CNetClientDup::SendPackage(const void* pData, UINT size) const
{
...
BOOL CNetClient::Startup(UINT maxFreeBuffers, UINT bufferSize, const char * pAddressToConnectServer, unsigned short usPortToConnectServer, BOOL block/* = TRUE*/)
{
...
BOOL CNetClient::SendPackage(const void* pData, UINT size)
{
