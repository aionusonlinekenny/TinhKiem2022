...
public:
	BOOL B_QueryChannelID(const std::_tstring& channel, DWORD ip, ULONG param, DWORD nameid);
	BOOL B_Subscribe(DWORD ip, ULONG param, DWORD channelid);
	BOOL B_Unsubscribe(DWORD ip, ULONG param, DWORD channelid);
	BOOL B_FreeChannID(DWORD channid, DWORD ip, ULONG param);
	BOOL B_ClearPlayer(DWORD ip, ULONG param);

	BOOL QueryChannelID(const std::_tstring& channel, DWORD ip, ULONG param, DWORD nameid);
	BOOL Subscribe(DWORD ip, ULONG param, DWORD channelid);
	BOOL Unsubscribe(DWORD ip, ULONG param, DWORD channelid);
	BOOL FreeChannID(DWORD channid, DWORD ip, ULONG param);
	BOOL ClearPlayer(DWORD ip, ULONG param);

	DWORD DoBlockOp(DWORD lmt);

	BOOL IsUsed(DWORD ip, ULONG param, DWORD channid);
	BOOL IsSubscribed(DWORD ip, ULONG param, DWORD channid);
...
private:
	...
	BOOL PassToGM(const void* pData, UINT size);
	BOOL PassToSpecMan(DWORD ToIP, ULONG ToRelayID, DWORD ToNameID, const void* pData, UINT size);

	typedef std::list<tagPlusSrcInfo>	MANLIST;
	BOOL PassToGroupMan(DWORD ToIP, BOOL verify, const MANLIST& mans, const void* pData, UINT size);
...
private:
	...
	typedef std::map<ULONG, PLAYERINFO>	PLAYERSMAP;
...
public:
	BOOL SayOnSomeone(DWORD ip, ULONG param, DWORD nameid, const std::_tstring& name, const std::_tstring& sent);
...
private:
	BOOL Block_QueryChannelID(const std::_tstring& channel, DWORD ip, ULONG param, DWORD nameid);
	BOOL Block_FreeChannID(DWORD channid, DWORD ip, ULONG param);
	BOOL Block_Subscribe(DWORD ip, ULONG param, DWORD channelid);
	BOOL Block_Unsubscribe(DWORD ip, ULONG param, DWORD channelid);
	BOOL Block_ClearPlayer(DWORD ip, ULONG param);
