...
CHostConnect::CHostConnect(CHostServer* pHostServer, ULONG id)
...
void CHostConnect::RecvPackage(const void* pData, UINT size)
{
...
void CHostConnect::Proc0_Normal(const void* pData, UINT size)
{
	EXTEND_HEADER* pHeader = (EXTEND_HEADER*)pData;
...
void CHostConnect::Proc1_Normal_EnterGame(const void* pData, UINT size)
{
...
void CHostConnect::Proc1_Normal_LeaveGame(const void* pData, UINT size)
{
...
void CHostConnect::Proc0_Relay(const void* pData, UINT size)
{
	EXTEND_HEADER* pHeader = (EXTEND_HEADER*)pData;
...
void CHostConnect::Proc1_Relay_Data(const void* pData, UINT size)
{
	...
	UINT sizeLoseData = sizeof(RELAY_DATA) + size;
	RELAY_DATA* pLoseDataDup = (RELAY_DATA*)_malloca(sizeLoseData);
...
void CHostConnect::Proc1_Relay_AskWay(const void* pData, UINT size)
{
...
void CHostConnect::Proc1_Relay_LoseWay(const void* pData, UINT size)
{
...
void CHostConnect::Proc2_Relay_AskWay_AccountRoleID(const void* pData, UINT size, BOOL acc)
{
	RELAY_ASKWAY_DATA* pAskWayData = (RELAY_ASKWAY_DATA*)pData;
	...
	if (find)
	{
		...
		UINT pckgsize = sizeof(DWORD) * 2 + size;
		RELAY_ASKWAY_DATA* pClntWayData = (RELAY_ASKWAY_DATA*)_malloca(pckgsize);
...
void CHostConnect::Proc2_Relay_AskWay_MapID(const void* pData, UINT size)
{
	RELAY_ASKWAY_DATA* pAskWayData = (RELAY_ASKWAY_DATA*)pData;
...
void CHostConnect::Proc2_Relay_AskWay_GM(const void* pData, UINT size)
{
	RELAY_ASKWAY_DATA* pAskWayData = (RELAY_ASKWAY_DATA*)pData;
...
void CHostConnect::Proc0_PlayerCommunity(const void* pData, UINT size)
{
	EXTEND_HEADER* pHeader = (EXTEND_HEADER*)pData;
...
void CHostConnect::Proc1_PlayerCommunity_QueryChannelID(const void* pData, UINT size)
{
...
void CHostConnect::Proc1_PlayerCommunity_FreeChannelID(const void* pData, UINT size)
{
...
void CHostConnect::Proc1_PlayerCommunity_Subscribe(const void* pData, UINT size)
{
...
void CHostConnect::OnClientConnectClose()
{
	...
	UINT pckgsize = sizeof(RELAY_ASKWAY_DATA) + sizeof(EXTEND_HEADER) + sizeof(KServerInfo);
...
BOOL CHostConnect::FindPlayerByAcc(const std::_tstring& acc, std::_tstring* pRole, DWORD* pNameID, ULONG* pParam, std::_tstring* pRealAcc)
{
...
BOOL CHostConnect::FindPlayerByRole(const std::_tstring& role, std::_tstring* pAcc, DWORD* pNameID, ULONG* pParam, std::_tstring* pRealRole)
{
	DUMMY_AUTOLOCKREAD(m_lockPlayer);
...
BOOL CHostConnect::FindPlayerByParam(ULONG param, std::_tstring* pAcc, std::_tstring* pRole, DWORD* pNameID)
{
	DUMMY_AUTOLOCKREAD(m_lockPlayer);
...
/*
BOOL CHostConnect::BroadOnPlayer(BOOL byAcc, DWORD fromIP, ULONG fromRelayID, const void* pData, UINT size)
{
	assert(pData != NULL && size > 0);

	UINT methodsize = _NAME_LEN + sizeof(DWORD) * 2;
	UINT pckgsize = sizeof(RELAY_ASKWAY_DATA) + methodsize + size;
...
UINT CHostConnect::GetPlayerCount()
{
	DUMMY_AUTOLOCKREAD(m_lockPlayer);
