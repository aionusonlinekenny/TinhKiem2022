...
static UINT gs_recvdatasize = 0;
static UINT gs_senddatasize = 0;
...
const UINT log_threshold = 1024 * 1024;
...
static void inline sLogProgram(BOOL bEnter)
{
	SYSTEMTIME systm;
	::GetLocalTime(&systm);
	TCHAR buff[256];
