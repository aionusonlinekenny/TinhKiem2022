...
public:
	...
	BOOL SomeoneSyncFriends(const std::string& role, ULONG param, DWORD nameid, const CNetConnectDup& conndup, BOOL full, BYTE pckgid);
...
private:
	...
	UINT m_StorePlayerPerUdtDB;
	UINT m_LoadPlayerPerUdtDB;
