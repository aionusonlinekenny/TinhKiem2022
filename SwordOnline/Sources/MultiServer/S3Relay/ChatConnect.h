...
{
public:
	CChatConnect(class CChatServer* pHostServer, ULONG id);
...
private:
	void Proc0_SomeoneChat(const void* pData, UINT size);
	void Proc0_ChannelChat(const void* pData, UINT size);
	void Proc0_GroupMan(const void* pData, UINT size);
