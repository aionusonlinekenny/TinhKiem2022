...
private:
	...
	void _CheckRoleName(const void* pData, UINT dataLength);
	void _ChangeRoleName(const void* pData, UINT dataLength);
	...
	public:
		...
		explicit CDataQueue( size_t bufferSize = 1024 * 128, size_t maxFreeBuffers = 160 );	//64
