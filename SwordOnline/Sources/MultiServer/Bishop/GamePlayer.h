...
private:
	...
	ULONG CalculateChecksum(const std::string& filename);
	...
	//static std::mutex		CGamePlayer::mutex;
	...
	OnlineGameLib::Win32::_tstring	m_sIP;
	...
	public:
		...
		explicit CDataQueue(size_t bufferSize = 1024 * 128, size_t maxFreeBuffers = 1); // 64
...
protected:
	...
	bool _VerifyAccount_ToPlayer(UINT nQueryResult, ULONG nLeftTime);
