...
#define	PLAYERCREATOR_FILE		"settings\\npc\\player\\newplayerini%02d.ini"
#define REVIVALID_FILENAME		"settings\\npc\\player\\revivalid.ini"
...
public:
	...
	const TRoleData*	GetRoleData( UINT &uDataLength, LPROLEPARAM lpParam );
