...
namespace OnlineGameLib {
	namespace Win32 {
		...
		public:
			...
			void AddData(BYTE cID, const char* const pData, size_t dataLength, ULONG lnUserData = 0);
			void AddData(BYTE cID, const BYTE* const pData, size_t dataLength, ULONG lnUserData = 0);
		...
		private:
			...
			*/
			...
			bool _Header(BYTE cFlag) { return ToBool<int32_t>(cFlag & enumPackHeader); }
			bool _Middle(BYTE cFlag) { return ToBool<int32_t>(cFlag & enumPackMiddle); }
			bool _Tail(BYTE cFlag) { return ToBool<int32_t>(cFlag & enumPackTail); }
			bool _Error(BYTE cFlag) { return ToBool<int32_t>(cFlag & enumPackErr); }
