...
namespace OnlineGameLib {
	namespace Win32 {
		...
		int32_t	 CIniFile::ReadInteger(LPCTSTR lpSectionName, LPCTSTR lpKeyName, int32_t nDefault)
		{
		...
		BOOL CIniFile::WriteInteger(LPCTSTR lpSectionName, LPCTSTR lpKeyName, int32_t nValue)
		{
