...
DEFINE_GUID(IID_IIOCPServer, 0xfc6b562e, 0x89c2, 0x4fbc, 0xbf, 0x5f, 0x55, 0x3c, 0x9, 0xae, 0x93, 0xd8);
...
DECLARE_INTERFACE_(IServer, IUnknown)
{
	 ...
	 */
	STDMETHOD_(size_t, GetClientCount)		() PURE;

	/*
	 * Get information from a specified client
	 */
	STDMETHOD_(const char*, GetClientInfo)	(const unsigned long& ulnClientID) PURE;

	STDMETHOD(SetShutdownClient) (const unsigned long& ulnClientID) PURE;
...
DEFINE_GUID(IID_IServerFactory, 0xa4984b66, 0x8cde, 0x4752, 0x9b, 0xee, 0xda, 0xcc, 0x6, 0xa6, 0x35, 0x48);
