...
public:
	...
	BOOL ConnectErrorWork(ULONG nID, ULONG Address, short Port);
	BOOL ConnectFreeWork(ULONG nID, ULONG Address, short Port);
	BOOL ConnectFreeForErrorWork(ULONG nID, ULONG Address, short Port);
	BOOL ConnectAgainWork(ULONG nID, ULONG Address, short Port);
	BOOL OutofWork(ULONG nID);
	BOOL IsWork();
	BOOL IsWorkAgain();
	BOOL IsWantData();
	BOOL IsError();
