...
// 返回:	void
//---------------------------------------------------------------------------
BOOL KBitmap::Init(int32_t nWidth, int32_t nHeight, int32_t nColors)
{
	m_nWidth = nWidth;
	m_nHeight = nHeight;
	m_nColors = nColors;
...
// 返回:	void
//---------------------------------------------------------------------------
void KBitmap::Draw(int32_t nX, int32_t nY)
{
...
// 返回:	void
//---------------------------------------------------------------------------
void KBitmap::PutPixel(int32_t nX, int32_t nY, BYTE byColor)
{
...
// 返回:	颜色值
//---------------------------------------------------------------------------
BYTE KBitmap::GetPixel(int32_t nX, int32_t nY)
{
	//	if ((nX < 0) || (nY < 0) || (nX >= m_nWidth) || (nY >= m_nHeight))
	//		return 0;
	PBYTE pPixel = (PBYTE)m_Bitmap.GetMemPtr();
