...
// 返回:	void
//---------------------------------------------------------------------------
void g_Pal24ToPal16(KPAL24* pPal24, KPAL16* pPal16, int32_t nColors)
{
...
// 功能:	16位调色板转化位16位调色板
//---------------------------------------------------------------------------
void g_Pal16ToPal24(KPAL16* pPal16, KPAL24* pPal24, int32_t nColors)
{
	if (pPal24 && pPal16 && nColors > 0)
	{
		//	_ASSERT(pPal24 && pPal16 && g_pDirectDraw && count > 0);
...
// 返回:	void
//---------------------------------------------------------------------------
void g_Pal32ToPal16(KPAL32* pPal32, KPAL16* pPal16, int32_t nColors)
{
	while (nColors-- > 0)
	{
...
// 返回:	void
//---------------------------------------------------------------------------
void g_Pal24ToPal16Style(KPAL24* pPal24, KPAL16* pPal16, int32_t nColors)
{
	while (nColors-- > 0)
	{
		*pPal16 = g_RGB(
...
// 返回:	void
//---------------------------------------------------------------------------
void g_Pal32ToPal16Style(KPAL32* pPal32, KPAL16* pPal16, int32_t nColors)
{
	while (nColors-- > 0)
	{
		*pPal16 = g_RGB(
...
// 返回:	void
//---------------------------------------------------------------------------
void g_Pal24ToPal16Gray(KPAL24* pPal24, KPAL16* pPal16, int32_t nColors)
{
	int32_t nGray;
	while (nColors-- > 0)
	{
...
// 返回:	void
//---------------------------------------------------------------------------
void g_Pal32ToPal16Gray(KPAL32* pPal32, KPAL16* pPal16, int32_t nColors)
{
	int32_t nGray;
	while (nColors-- > 0)
	{
...
// 返回:	void
//---------------------------------------------------------------------------
void g_Pal24ToPal16Lum(KPAL24* pPal24, KPAL16* pPal16, int32_t nColors)
{
	int32_t lum, i;
...
// 返回:	void
//---------------------------------------------------------------------------
void g_Pal32ToPal16Lum(KPAL32* pPal32, KPAL16* pPal16, int32_t nColors)
{
	int32_t lum, i;
	for (lum = 32; lum > 0; lum--)
	{
...
// 返回:	void
//---------------------------------------------------------------------------
void g_Pal24ToPal32(KPAL24* pPal24, KPAL32* pPal32, int32_t nColors)
{
...
// 返回:	void
//---------------------------------------------------------------------------
void g_Pal32ToPal24(KPAL32* pPal32, KPAL24* pPal24, int32_t nColors)
{
	for (int32_t i = 0; i < nColors; i++)
	{
