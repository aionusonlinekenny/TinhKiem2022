...
void KCanvas::DrawSpriteAlphaMMX(BYTE byInputAlpha, DWORD dwMask32, void* pBuffer, INT width, INT height,
	INT nPitch, INT nX, INT nY, void* pPalette, void* pSprite, INT nWidth, INT nHeight, const RECT* pSrcRect)
{
	g_DrawSpriteScreenBlendMMX(byInputAlpha, dwMask32, pBuffer, width, height,
		nPitch, nX, nY, pPalette, pSprite, nWidth, nHeight, pSrcRect);
}
