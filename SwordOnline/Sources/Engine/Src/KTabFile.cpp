...
BOOL KTabFile::IsTabExist(LPSTR FileName)
{
	KPakFile	File;
...
void KTabFile::CreateTabOffset()
{
	...
	Buffer = (PBYTE)m_Memory.GetMemPtr();
...
//----------------------------------------------------------------------------
//Function: GetDouble
//Function: Get the value of a string in a row or column
//Parameters: nRow row
//szColomn column
//nDefault default value
//pnValue return value
//Return: whether successful
//----------------------------------------------------------------------------
BOOL KTabFile::GetDouble(int nRow, LPSTR szColumn, double fDefault, double* pfValue, BOOL bColumnLab)
{
	char	Buffer[64];
	int		nColumn;
	if (bColumnLab)
