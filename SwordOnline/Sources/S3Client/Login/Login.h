...
private:
	...
	unsigned long CalculateChecksum(const std::string& filename);
...
private:
	...
	struct	LOGIN_CHOICE
	{
		...
		bool					bVirtualKeyboard;			//是否纪录登陆账号
	}							m_Choices;
};
