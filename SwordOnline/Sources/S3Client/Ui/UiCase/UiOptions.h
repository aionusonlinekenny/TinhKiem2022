...
#define	MAX_TOGGLE_BTN_COUNT	4
	...
	UINT	m_uEnableTextColor;		//m_ToggleBtn标题文字的颜色
	UINT	m_uDisableTextColor;	//m_ToggleBtn标题文字的颜色
	UINT	m_uInvalidTextColor;	//m_ToggleBtn标题文字的颜色
