...
INT KUiChooseFace::WndProc(UINT uMsg, UINT uParam, INT nParam)
{
	INT nResult = false;
	switch (uMsg)
	{
	...
	case WND_N_BUTTON_CLICK:
		if (uParam == (UINT)(KWndWindow*)&m_CloseBtn)
			CloseWindow();
		else if (uParam == (UINT)(KWndWindow*)&m_OkBtn)
			OnOK();
		else if (uParam == (UINT)(KWndWindow*)&m_OneFemaleBtn)
		{
			nCheck = 1;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_TwoFemaleBtn)
		{
			nCheck = 2;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_ThreeFemaleBtn)
		{
			nCheck = 3;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_FourFemaleBtn)
		{
			nCheck = 4;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_FiveFemaleBtn)
		{
			nCheck = 5;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_SixFemaleBtn)
		{
			nCheck = 6;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_SevenFemaleBtn)
		{
			nCheck = 7;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_EightFemaleBtn)
		{
			nCheck = 8;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_NineFemaleBtn)
		{
			nCheck = 9;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_TenFemaleBtn)
		{
			nCheck = 10;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_ElevenFemaleBtn)
		{
			nCheck = 11;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_TwelveFemaleBtn)
		{
			nCheck = 12;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_OneMaleBtn)
		{
			nCheck = 13;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_TwoMaleBtn)
		{
			nCheck = 14;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_ThreeMaleBtn)
		{
			nCheck = 15;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_FourMaleBtn)
		{
			nCheck = 16;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_FiveMaleBtn)
		{
			nCheck = 17;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_SixMaleBtn)
		{
			nCheck = 18;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_SevenMaleBtn)
		{
			nCheck = 19;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_EightMaleBtn)
		{
			nCheck = 20;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_NineMaleBtn)
		{
			nCheck = 21;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_TenMaleBtn)
		{
			nCheck = 22;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_ElevenMaleBtn)
		{
			nCheck = 23;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_TwelveMaleBtn)
		{
			nCheck = 24;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_ThirteenMaleBtn)
		{
			nCheck = 25;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_FourteenMaleBtn)
		{
			nCheck = 26;
		}
		else if (uParam == (UINT)(KWndWindow*)&m_FifteenMaleBtn)
		{
			nCheck = 27;
		}
		break;
