...
#define	POPUPING_MSG_HEAP_INDEX		SMT_WAR
...
private:
	...
	void	OnConfirmOperFinished(UINT uParam, INT nSelAction);	//响应操作结束，玩家已经做出选择。
...
private:
	...
	UINT			m_uLastMovementTime;
	UINT			m_uMoveInterval;
	UINT			m_uDisappearInterval;
	...
	KUiImageRef				m_MsgIcon[SMT_WAR];	//消息图标的图形
	int16_t					m_nMsgIconFrame[SMT_WAR];//消息图标的图形帧索引
