...
#define	MAX_NUM_BUTTERFLY	3
	...
	UINT	m_uAdviceIntervalMin[MAX_NUM_BUTTERFLY];
	UINT	m_uAdviceIntervalMax[MAX_NUM_BUTTERFLY];
	UINT	m_uInterval[MAX_NUM_BUTTERFLY];
	UINT	m_uLastSleepTime[MAX_NUM_BUTTERFLY];
	char			m_szConfig[32];
};
