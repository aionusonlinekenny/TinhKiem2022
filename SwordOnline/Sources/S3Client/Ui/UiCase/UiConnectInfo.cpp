...
INT KUiConnectInfo::WndProc(UINT uMsg, UINT uParam, INT nParam)
{
	switch (uMsg)
	{
	case WND_N_BUTTON_CLICK:
		if (uParam == (UINT)(KWndWindow*)&m_ConfirmBtn)
			OnClickConfirmBtn();
		else if (uParam == (UINT)(KWndWindow*)&m_DelRoleBtn)
			OnDelRole();
		else if (uParam == (UINT)(KWndWindow*)&m_CancelDelRoleBtn)
			OnCancelDelRole();
		break;
	case WM_KEYDOWN:
