...
public:
	//----界面面板统一的接口函数----
	static KUiTrade*	OpenWindow(KUiPlayerItem* pOther, BOOL bFolkGame);//打开窗口，返回唯一的一个类对象实例
...
private:
	...
	UINT		m_uWaitTradeMsgColor;
	UINT		m_uOtherLockMsgColor;
	UINT		m_uOtherNotLockMsgColor;

	BOOL				m_bTradeFolkGame;
};
