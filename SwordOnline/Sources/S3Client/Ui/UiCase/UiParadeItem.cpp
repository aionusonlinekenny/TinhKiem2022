...
//	¹¦ÄÜ£º´°¿Úº¯Êý
//--------------------------------------------------------------------------
INT KUiParadeItem::WndProc(UINT uMsg, UINT uParam, INT nParam)
{
	INT nRet = 0;
	switch (uMsg)
	{
	case WND_N_BUTTON_CLICK:
		if (uParam == (UINT)(KWndWindow*)&m_Close)
			Hide();
...
void KUiParadeItem::UpdateAllEquips(KUiPlayerItem* pDest)
{
	...
	INT nCount = g_pCoreShell->GetGameData(GDI_PARADE_EQUIPMENT, (UINT)&Equips, 0);
	INT	i;
