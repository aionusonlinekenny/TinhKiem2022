...
private:
	...
	void	SetPopupSelMapNE(INT nSel);
private:
	...
	KWndButton			m_OtherWithDrawCK;
	KWndText32			m_OtherWithDrawTxt;
	KWndEdit32			m_OtherWithDrawEdit;
	...
	KWndButton			m_TrainingMapPopup;
	KWndText80			m_TrainingMapTxt;
	KWndText80			m_TrainingMapTxtSel;
	KWndShadow			m_TrainingMapShadow;
...
private:
	...
	KWndButton			m_SellTrashCK;
	KWndText32			m_SellTrashTxt;
...
public:
	...
	static void		SwitchStatus(BOOL bActive) {
		m_pSelf->m_CheckActive = bActive;
		SavePrivateSetting();
	};
	static BOOL		GetStatus() { return m_pSelf->m_CheckActive; };
private:
	KUiAutoPlay() {
		m_CheckActive = FALSE;
	}
