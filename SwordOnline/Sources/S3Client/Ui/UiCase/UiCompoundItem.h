...
private:
	...
	KCanGetNumImage2	m_TrembleEffect1;                   //合成中的特效
	KCanGetNumImage2	m_TrembleEffect2;                   //合成中的特效
	KCanGetNumImage2	m_TrembleEffect3;                   //合成中的特效
private:
...
public:
	...
	INT		 GetWindowsNum();
	void	CleanItem();
	void	ComItem(UINT pItem, INT nWindowNum, INT nNum);
private:
	KUiComItem() {}
	~KUiComItem() {}
	void	Initialize();							//初始化
...
private:
	...
	INT			  m_nNum;
	KCanGetNumImage2	m_TrembleEffect;
};
