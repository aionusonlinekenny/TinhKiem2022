...
//	功能：窗口消息函数
//--------------------------------------------------------------------------
INT KUiInit::WndProc(UINT uMsg, UINT uParam, INT nParam)
{
	INT nRet = 0;
	switch (uMsg)
	{
...
INT KUiInit::OnKeyDown(UINT uKey)
{
	INT	nRet = 1;
