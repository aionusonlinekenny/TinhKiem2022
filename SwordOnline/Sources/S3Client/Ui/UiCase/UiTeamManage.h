...
private:
	...
	KWndLabeledButton		m_btnInvite;			// 邀请
	KWndLabeledButton		m_btnKick;				// 踢出
	//	KWndButton				m_btnApplyJoin;			// 申请加入

	KWndLabeledButton		m_btnAppoint;			// 任命
	KWndLabeledButton		m_btnLeave, m_btnDismiss;// 离队、解散
	KWndLabeledButton		m_btnCloseTeam;			// 关闭组队
	KWndLabeledButton		m_btnRefresh;			// 刷新
