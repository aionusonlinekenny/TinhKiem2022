...
private:
	int16_t			m_nUpFrame;
	int16_t			m_nDownFrame;
	int16_t			m_nCheckOverFrame;
	int16_t			m_nOverStartFrame;
	int16_t			m_nDisableFrame;
...
public:
	...
	void			SetImage(int16_t nType, const char* pszImgName, bool bAdjustWndSize = false);
};
