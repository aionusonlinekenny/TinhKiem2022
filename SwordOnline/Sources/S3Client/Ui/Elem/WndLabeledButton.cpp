...
//	功能：设置按钮标题文字颜色
//--------------------------------------------------------------------------
void KWndLabeledButton::SetLabelColor(UINT Color)
{
	m_FontColor = Color;
}

void KWndLabeledButton::SetLabelBorderColor(UINT Color)
{
...
void KWndLabeledButton::PaintWindow()
{
	...
	if (g_pRepresentShell)
	{
		...
		if (pShowString)
		{
			...
			UINT uColor = m_FontColor;
			UINT uBorderColor = m_FontBorderColor;
