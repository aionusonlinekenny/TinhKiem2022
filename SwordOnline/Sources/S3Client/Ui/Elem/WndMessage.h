...
#define WND_N_BUTTON_LCLICK			WND_M_BUTTON_BASE + 7	//双击按钮操作
//(KWndWindow*)uParam = 被点击的按钮窗口的指针
...
#define WND_N_EDIT_LCLICK			WND_M_EDIT_BASE + 3	//点击按钮操作
#define WND_N_EDIT_RCLICK			WND_M_EDIT_BASE + 4	//点击按钮操作

#define WND_N_EDIT_KILL_FOCUS		WND_M_EDIT_BASE + 5	//点击按钮操作
...
struct KUiDraggedObject
{
	...
	INT m_posvs;
	unsigned char m_dirvs,m_ucdelay,m_lastframe,m_vs_lastframe;
};
