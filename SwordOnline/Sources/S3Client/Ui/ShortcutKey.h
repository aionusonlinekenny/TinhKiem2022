...
#define SCK_SHORTCUT_ITEMEX	"Open([[itemex]])"
...
#define SCK_SHORTCUT_TONG	"Open([[tong]])"
...
#define SCK_SHORTCUT_FASTPK		"Switch([[fastpk]])"
...
#define SCK_SHORTCUT_AUTO	"Switch([[openauto]])"
#define SCK_SHORTCUT_CHATROOM	"Switch([[chatroom]])"
...
{
public:
	static INT			HandleKeyInput(UINT uKey, INT nModifier);
	static INT			HandleMouseInput(UINT uKey, INT nModifier, INT x, INT y);
