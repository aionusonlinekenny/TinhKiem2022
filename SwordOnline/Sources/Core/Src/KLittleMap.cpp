...
{
	//if (m_ppbtBarrier)
	if (this->m_ppbtBarrier)// find way by kinnox;
	{
...
// find way by kinnox;
RECT* KLittleMap::GetRect()
{
	g_DebugLog("KLittleMap::GetRect(): %d - %d - %d - %d ",m_sMapRect.left,m_sMapRect.top,m_sMapRect.right,m_sMapRect.bottom);
	return &m_sMapRect;
}
//
//---------------------------------------------------------------------------
