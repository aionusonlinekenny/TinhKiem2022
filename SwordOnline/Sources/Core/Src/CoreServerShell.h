...
enum GAMEDATA_INDEX
{
	...
	SGDI_TONG_SAVEEFF_POWER,
	SGDI_TONG_CHANGE_MONEY,
	SGDI_TONG_CHANGE_AGNAME_POWER,
	SGDI_TONG_GET_AGNAME_POWER,
	SGDI_TONG_CHANGE_SEX_AGNAME_POWER,
	SGDI_TONG_BE_CHANGED_AGNAME,
	SGDI_CHARACTER_SEX,
	SGDI_TONG_APPLY_CHANGE_CAMP,
	SGDI_TONG_BE_CHANGED_CAMP,
	SGDI_TONG_BE_CHANGED_LEVEL,
	SGDI_TONG_BE_CHANGED_MONEY,
	SGDI_TONG_BE_CHANGED_TONG_EFF,
	SGDI_TONG_BE_CHANGED_RECRUIT,
	SGDI_TONG_BE_CHANGED_TONGPARAM,
	SGDI_TONG_BE_CHANGED_JIYU,
	SGDI_TONG_BE_CHANGED_EFF,
	SGDI_TONG_CHANGE_RECRUIT,
	SGDI_TONG_CHANGE_TONGPARAM,
	SGDI_TONG_CHANGE_INFO_TONG,
	SGDI_PLAYER_OFFLINE,
	SGDI_PLAYER_LOGOUT_GATEWAY,
	SGDI_PLAYER_COUNT,
};
...
#endif
{
	...
	virtual bool IsPlayerOffline(INT nIndex) = 0;
	virtual void PlayerOfflineGateway(INT nIndex) = 0;
	...
	virtual bool PlayerDbLoading(INT nPlayerIndex, INT bSyncEnd, INT& nStep, UINT& nParam) = 0;
	virtual INT  AttachPlayer(const ULONG lnID, GUID* pGuid) = 0;
	...
	//向游戏发送操作
	virtual INT	 OperationRequest(UINT uOper, UINT uParam, INT nParam) = 0;
	//获取连接状况
	...
	virtual bool SetChangeRoleStatus(INT nIndex, INT uStatus, char* nRoleName) = 0;

	virtual BOOL GroupChat(IClient* pClient, DWORD FromIP, ULONG FromRelayID, DWORD channid, BYTE tgtcls, DWORD tgtid, const void* pData, size_t size) = 0;
