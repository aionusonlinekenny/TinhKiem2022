...
public:
	...
	struct SECTINFO
	{
		...
		char			szSectResName[MAX_PATH];		// 此部件对应的资源说明文件名
		char			szSectSprInfoName[MAX_PATH];	// 此部件对应的资源信息说明文件
		char			szSectEffectName[MAX_PATH];
		char			szSectEffectInfoName[MAX_PATH];
		SECTINFO() { Clear(); };
