...
BOOL KMissionPlayerArray::SetParam(ULONG ulIndex, INT nParam, INT nValue)
{
	if (ulIndex >= ulSize)
		return FALSE;
...
BOOL KMission::StopMission()
{
	...
	while (nIdx)
	{
		...
		if (Npc[nTargetIndex].m_RegionIndex >= 0)
		{
			...
			SubWorld[Npc[nTargetIndex].m_SubWorldIndex].m_Region[Npc[nTargetIndex].m_RegionIndex].DecNpcRef(Npc[nTargetIndex].m_MapX, Npc[nTargetIndex].m_MapY, obj_npc);
		}
...
ULONG	KMission::AddPlayer(ULONG ulPlayerIndex, ULONG ulPlayerID, unsigned char ucPlayerGroup, INT ulJoinTime/* = 0*/)
{
...
ULONG	KMission::AddNpc(ULONG ulNpcIndex, ULONG ulNpcID, unsigned char ucNpcGroup, INT ulJoinTime/* = 0*/)
{
...
BOOL	KMission::RemovePlayer(ULONG ulPlayerIndex, ULONG ulPlayerID)
{
...
BOOL	KMission::RemoveNpc(ULONG ulNpcIndex, ULONG ulNpcID/* = 0*/)
{
	...
	if (m_MissionNpc.Remove(&Info))
	{
		if (Npc[ulNpcIndex].m_RegionIndex >= 0)
		{
			...
			SubWorld[Npc[ulNpcIndex].m_SubWorldIndex].m_Region[Npc[ulNpcIndex].m_RegionIndex].DecNpcRef(Npc[ulNpcIndex].m_MapX, Npc[ulNpcIndex].m_MapY, obj_npc);
		}
...
void KMission::SetPlayerParam(ULONG ulIndex, INT nParam, INT nValue)
{
