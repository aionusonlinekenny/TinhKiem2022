...
#define		CHANGERES_PLATINA_FILE			"\\settings\\item\\platinaequipres.txt"
...
#define		OFFLINE_SCRIPT				"\\script\\system\\offline.lua"
...
#define		MSG_TONG_APPLY_ADD_ERROR4		"B¹n võa chñ ®éng rêi khái bang héi, ®ang trong thêi gian thö th¸ch kh«ng thÓ göi yªu cÇu (%d phót)"
...
#define		MSG_PLAYER_CHANGE_NAME_INVALID	"Kh«ng thÓ sö dông tªn nh©n vËt nµy"
#define		MSG_PLAYER_CHANGE_NAME_LENGHT_INVALID	"Tªn nh©n vËt ph¶i cã ®é dµi tõ 8 ®Õn 30 ký tù"
#define		MSG_PLAYER_CHANGE_NAME_SUCCESS	"Tªn nh©n vËt ®· ®­îc thay ®æi thµnh c«ng"

#define		defWorldRank_1					"Vâ L©m §Ö NhÊt Cao Thñ"
#define		defWorldRank_2					"Vâ L©m §Ö NhÞ Cao Thñ"
#define		defWorldRank_3					"Vâ L©m §Ö Tam Cao Thñ"
#define		defWorldRank_4					"Vâ L©m Cao Thñ H¹ng"
...
enum enumMSG_ID
{
	...
	enumMSG_ID_NPC_NAME_INVALID,
	enumMSG_ID_NPC_NAME_LENGHT_INVALID,
	enumMSG_ID_NPC_NAME_SUCCESS,
	enumMSG_ID_NUM,
};
