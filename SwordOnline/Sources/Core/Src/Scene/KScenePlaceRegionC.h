...
class KScenePlaceRegionC
{
  ...
  public:
	...
	void SetHightLightSpecialObject(UINT uBioIndex);
	void UnsetHightLightSpecialObject(UINT uBioIndex);
  ...
  private:
	...
	{
		UINT uNumGrunode;	//地表格图形的数目
		UINT uNumObject;	//紧贴地面的类似路面之类的对象的数目
