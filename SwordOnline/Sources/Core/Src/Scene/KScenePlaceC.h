...
public:
	...
	//设置地图参数
	void SetMapParam(UINT uShowElems, INT nSize);
	//设置场景的地图的焦点(单位:场景坐标)
	...
	void JxPathFinderClear();
#endif
	BOOL nPaintFindPos;//PaintFindPos by kinnox;
private:
...
private:
	...
	enum SP_WORKING_PARAM {
		...
		//没有场景
		SPWP_NO_SCENE = -1,
		SPWP_PROCESS_RANGE_H = 2,
		SPWP_PROCESS_RANGE_V = 2,
	};
