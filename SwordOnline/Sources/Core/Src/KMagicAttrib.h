...
enum MAGIC_ATTRIB
{
	...
	magic_lightingdamage_p,					//65
	magic_poisondamage_v,					//66
	magic_physicsenhance_p,					//67
	magic_steallife_p,						//68
	magic_stealmana_p,						//69
	magic_stealstamina_p,					//70
	magic_knockback_p,						//71
	magic_deadlystrike_p,					//72
	magic_fatallystrike_p,					//73
	magic_stun_p,							//74
	...
	magic_autocastskill,					//303
	magic_addlightingmagic_p,					//304
	magic_special_point_base,					//305
	magic_special_point_add,					//306
	magic_normal_end,						//307
};
