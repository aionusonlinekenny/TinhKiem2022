...
#define KPROTOCOL_EXPIRATION_DATE   20251220 // time limited   year/month/date
#define KPROTOCOL_VERSION   20240712 // time limited  year/month/date
/*
 *
 */
...
enum s2c_PROTOCOL
{
	...
	s2c_gamestatistic,
	s2c_punish,
	s2c_rolecheckname_result, //检测角色名的 返回结果
	...
	s2c_npcpos, //TamLTM fix lag posu
	s2c_exitgame,	//ExitGame
	s2c_syncnpcstate,	//npc sync state
	s2c_chataddfriend,
...
enum c2s_PROTOCOL
{
	...
	c2s_gamestatistic,
	c2s_roleserver_lock,
	c2s_rolecheckname_result,
	c2s_rolechangename_result,
	...
	c2s_offline,//TamLTM offline
	c2s_compound,	// compound
	c2s_enchase,	// compound
	c2s_directsale,	// direct sale
	c2s_withdrawamoney,
...
enum
{
	...
	enumC2S_PLAYERCOMMAND_ID_GOMAP,
};
